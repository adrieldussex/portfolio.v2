    ...
    return (
        <>        
            ...
            <div className="w-full h-full grid grid-cols-2 gap-4">
                <div>
                    <h2 className="text-2xl font-semibold text-gray-200 mb-2">Habilidades e intereses</h2>
                ...
                <div>
                    <h2 className="text-2xl font-semibold text-gray-200 mb-2">Formación</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-200">¡Extra! ¡Extra!</h2>
