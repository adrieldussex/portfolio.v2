    ...
    <header className="lg:sticky lg:top-0 flex flex-col justify-between lg:min-h-screen lg:max-h-screen lg:w-2/5 pt-12 lg:py-24">
        <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-2">
                <p className="text-5xl font-bold text-gray-800 dark:text-gray-200 tracking-tight">Adriel Dussex</p>
                <p className="text-xl font-semibold text-gray-800 dark:text-gray-200">Diseñador gráfico y Desarrollador web</p>
                <p className="text-lg mb-2 lg:w-3/4">Me gusta trabajar en proyectos escalables enfocados en la experiencia de usuario</p>
            ...
            <button className="rounded-t-md bg-gray-50/20 dark:bg-gray-800/20 mx-auto lg:mx-0 w-full md:w-3/5 lg:w-2/5 border-b-4 border-b-transparent hover:border-b-sky-500 dark:hover:border-b-sky-500 h-full py-4 text-center text-gray-800 dark:text-gray-200 font-semibold tracking-wider border-t-[1px] border-gray-100/80 dark:border-gray-800/30">Descargar CV</button>
        </div>
